...
- [1 论文概览](#1-论文概览)
- [2 背景与定位](#2-背景与定位)
- [3 DeepSeekMoE 的专家重组机制](#3-deepseekmoe-的专家重组机制)
- [4 从 2B 受控实验到 16B 扩展的证据](#4-从-2b-受控实验到-16b-扩展的证据)
- [5 局限、适用边界与复现条件](#5-局限适用边界与复现条件)
- [6 结论与未决问题](#6-结论与未决问题)
- [7 我的研究判断](#7-我的研究判断)
- [8 版本、发布与后续工作](#8-版本发布与后续工作)
...
![Figure 1: DeepSeekMoE 的细粒度专家分割与共享专家隔离](assets/figure-1.png)
...
![Table 1: 2B 等预算 validation experiments](assets/table-1.png)
...
![Table 3: DeepSeekMoE 与更大 GShard 及 Dense 容量对照](assets/table-3.png)
...
![Figure 2: 共享专家与专家粒度消融](assets/figure-2.png)
...
![Figure 3: 屏蔽最高路由概率专家后的 Pile loss](assets/figure-3.png)
...
![Table 2: DeepSeekMoE 16B 与 7B dense baselines 的能力和计算比较](assets/table-2.png)
